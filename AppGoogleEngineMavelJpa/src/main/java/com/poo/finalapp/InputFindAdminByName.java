...
public class InputFindAdminByName extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse response) throws ServletException, IOException {
	     ...
	     out.println("<h3>Buscador de administrador</h3>"+
		  
		  "<p>Introduce nombre a buscar:</p>"+
