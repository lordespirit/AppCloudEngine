...
public class InsertGallerySelectAdmin extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse response) throws ServletException, IOException {
	      ...
	      if(listAdmins.size()==0||listAdmins==null){
	    	  ...
	    	  out.println("<h2>Selecciona un administrador de la lista para añadir la galería</h2>"
	    	  		+ "<form id='administradores' action='/InsertGallery' method='post'>");
	    	  ...
	    	  out.println("<table style='text-align:center;' bgcolor ='#FFF5EE' border='1' cellpadding='10' cellspacing='1' width='40%''>"
	    	  		+ "<tr>"
	    	  		+ "<td width='70%' ><p style='color:black'>Introduce nombre de la galería:</p></td>"
	    	  		+ "<td width='50%'><input type = 'text' name = 'gallery' required/></td>"
	    	  		+ "</tr>"
	    	  		+ "</table>");

	    	  out.println("<input type = 'submit' value = 'Insert Gallery' />");
	    	  out.println("</form>");
