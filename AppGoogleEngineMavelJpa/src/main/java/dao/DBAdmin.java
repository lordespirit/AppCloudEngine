...
public class DBAdmin extends DBManager implements AdminServices {
	...
	public void removeGallery(Gallery gallery) {
		...
		if(gallery==null){
			...
			if(gallery.getId()==0){
				throw new RuntimeException("El item enviado no es v�lido");
			}else{
	...
	public void update(Gallery gallery) {
		...
		if(gallery==null){
			...
			throw new RuntimeException("La galer�a no existe");
		}else{
				connect();
	...
	public void createItem(Gallery gallery, Item item) {
		...
		if(gallery==null||item==null){
			...
			if(galleryRecovered==null)
				throw new RuntimeException("La galer�a que pasada no existe");
			else{		
